...
export class sys_thong_bao_popupComponent {
  public user_model = new user_model();
  public lst_status: any = [];
  public check_error: any = [];
  constructor(
    private http: HttpClient,
    private sys_thong_bao_service: sys_thong_bao_service,
    public dialog: MatDialog,
    public dialogRef: MatDialogRef<sys_thong_bao_popupComponent>,
