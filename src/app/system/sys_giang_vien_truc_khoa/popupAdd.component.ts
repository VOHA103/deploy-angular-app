...
export class sys_giang_vien_truc_khoa_popupComponent {
  public user_model = new user_model();
  public lst_status: any = [];
  public check_error: any = [];
  constructor(
    private http: HttpClient,
    private sys_giang_vien_truc_khoa_service: sys_giang_vien_truc_khoa_service,
    public dialog: MatDialog,
    public dialogRef: MatDialogRef<sys_giang_vien_truc_khoa_popupComponent>,
