...
let sys_hoat_dong_giang_vien_service = class sys_hoat_dong_giang_vien_service {
    http;
    ...
    edit(sys_hoat_dong_giang_viens) {
...
sys_hoat_dong_giang_vien_service = __decorate([
    Injectable({
        providedIn: 'root',
    }),
    __metadata("design:paramtypes", [HttpClient])
], sys_hoat_dong_giang_vien_service);
export { sys_hoat_dong_giang_vien_service };
//# sourceMappingURL=sys_hoat_dong_giang_vien.service.js.map