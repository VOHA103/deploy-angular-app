...
let sys_ky_truc_khoa_indexComponent = class sys_ky_truc_khoa_indexComponent {
    http;
    ...
    searchKey;
    constructor(http, sys_ky_truc_khoa_service, dialog) {
        this.http = http;
...
sys_ky_truc_khoa_indexComponent = __decorate([
    Component({
...
export { sys_ky_truc_khoa_indexComponent };
