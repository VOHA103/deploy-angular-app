...
let sys_user_indexComponent = class sys_user_indexComponent {
    http;
    sys_user_service;
    dialog;
    foods = [];
    ...
    searchKey;
    constructor(http, sys_user_service, dialog) {
        this.http = http;
...
sys_user_indexComponent = __decorate([
    Component({
...
export { sys_user_indexComponent };
