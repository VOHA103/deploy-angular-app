...
let sys_hoat_dong_indexComponent = class sys_hoat_dong_indexComponent {
    http;
    ...
    searchKey;
    constructor(http, sys_hoat_dong_service, dialog) {
        this.http = http;
...
sys_hoat_dong_indexComponent = __decorate([
    Component({
...
export { sys_hoat_dong_indexComponent };
